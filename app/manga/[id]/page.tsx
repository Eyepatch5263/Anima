                  ...
                  {manga.externalLinks && manga.externalLinks.filter(Boolean).map(link => {
                    ...
                    return (
                      <a
                        ...
                        className="flex items-center justify-between py-1.5 px-2 rounded-lg bg-white/[0.01] hover:bg-white/[0.04] border border-white/5 text-[#b3b3b3] hover:text-white transition-all font-semibold"
                      >
                        <span>{link.site}</span>
                  ...
                  {manga.streamingEpisodes && manga.streamingEpisodes.filter(Boolean).map((ep, idx) => {
                    ...
                    return (
                      <a
                        ...
                        className="flex items-center justify-between py-1.5 px-2 rounded-lg bg-white/[0.01] hover:bg-white/[0.04] border border-white/5 text-[#b3b3b3] hover:text-white transition-all font-semibold"
                      >
                        <span className="truncate max-w-[150px]">{ep.title || ep.site || 'Read / Stream'}</span>
                        <ChevronRightIcon size={12} className="text-[#808080]" />
                      </a>
                    )
                  })}
