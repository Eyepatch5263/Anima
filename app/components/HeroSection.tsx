    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center pt-24 pb-20">
        ...
        >
          <a
            href="/explore"
            className="group inline-flex items-center gap-2.5 px-8 py-3.5 text-sm font-semibold text-white rounded bg-[#e50914] hover:bg-[#f6121d] shadow-lg shadow-red-900/25 transition-all duration-300 hover:scale-[1.02]"
          >
            Explore Anime
          ...
          <a
            href="#ai-discovery"
            className="group inline-flex items-center gap-2.5 px-8 py-3.5 text-sm font-semibold text-white rounded border border-white/20 hover:border-white/40 bg-white/5 hover:bg-white/10 transition-all duration-300"
          >
            Try AI Discovery
          </a>
        </motion.div>
