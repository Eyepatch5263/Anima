              ...
              >
                ...
                <div className="pt-2 w-full md:w-auto">
                  <Link
                    ...
                    className="group flex md:inline-flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white font-semibold px-5 py-2.5 rounded-xl transition-all text-xs uppercase tracking-wider w-full md:w-auto"
                  >
                    Try It Out
                    <svg
