...
import { GetGenresQuery } from '@/src/manga/Query'
      ...
      <div className="relative">
        <button
          ...
          className={`flex items-center justify-between gap-2 w-full min-w-[130px] px-3 py-2 rounded-lg text-sm border transition-all duration-200 ${
            value ? 'bg-surface-raised border-white/15 text-white' : 'bg-surface-raised border-white/8 text-text-muted'
            ...
            >
              ...
              <button
                ...
                className={`w-full text-left px-3 py-2 text-sm transition-colors ${
                  !value ? 'text-white bg-white/8' : 'text-text-secondary hover:bg-white/5 hover:text-white'
                }`}
              >
                Any
              </button>
              {options.map(opt => (
                <button
                  ...
                  className={`w-full text-left px-3 py-2 text-sm transition-colors ${
                    value === opt.value ? 'text-white bg-white/8' : 'text-text-secondary hover:bg-white/5 hover:text-white'
                  }`}
                >
                  {opt.label}
                </button>
